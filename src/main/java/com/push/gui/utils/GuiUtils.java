...
public class GuiUtils {
    ...
    public static ImageIcon getDefaultPersonIcon(int width,int height){
      return getIconByFileName("user",width,height);
    }

    public static ImageIcon getDefaultSmsIcon(int width,int height){
        return getIconByFileName("chat",width,height);
    }

    public static ImageIcon getIconByFileName(String file,int width,int height){
        try {
    ...
    public static ImageIcon getDefaultMissedCallIcon(int width, int height) {
        return getIconByFileName("missed",width,height);
    }

    public static ImageIcon getDefaultOutgoingCall(int width,int height){
        return getIconByFileName("outgoing",width,height);
    }

    public static Icon getDefaultUnreadMessagesIcon(int width, int height) {
        return getIconByFileName("unreadMessages",width,height);
    }

    public static Icon getDefaultInfo(int width, int height) {
